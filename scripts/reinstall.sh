...
# pre-install some commonly used software.
    InstallComponents="$1 apt install sudo apt-transport-https ca-certificates cron curl debian-keyring debian-archive-keyring dnsutils iptables lsb-release mtr-tiny net-tools python unzip vim wget xz-utils -y;"
